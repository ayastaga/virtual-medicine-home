        ...
        <div class='sidebar'>
            <div class='sidebar-area'>
                ...
                <ul class='sidebar-menu'>
                    ...
                    <li><a href='patients.php'><img class='sidebar-menu-icon' src='images/ic_assignment_ind_white_24dp.png' />
                            Patients Book</a></li>
                    <li><a href='add-doctors.php'><img class='sidebar-menu-icon' src='images/ic_group_add_white.png' /> Add
                            Doctors</a></li>
                    <li><a href='doctors-record.php'><img class='sidebar-menu-icon' src='images/ic_group_add_white.png' />
                            Doctors' Records</a></li>
                    <li><a href='appointments.php'><img class='sidebar-menu-icon' src='images/ic_alarm_white_24dp.png' />
                            Appointment</a></li>
        ...
        <div class='sidebar'>
            <div class='sidebar-area'>
                ...
                <ul class='sidebar-menu'>
                    ...
                    <li><a href='patients.php'><img class='sidebar-menu-icon' src='images/ic_assignment_ind_white_24dp.png' />
                            Patients Book</a></li>
                    <li><a href='new-patient.php'><img class='sidebar-menu-icon' src='images/ic_group_add_white.png' /> Add
                            Patient</a></li>
                    <li><a href='appointments.php'><img class='sidebar-menu-icon' src='images/ic_alarm_white_24dp.png' />
                            Appointment</a></li>
                </ul>
    ...
    <div class='sidebar'>
        <div class='sidebar-area'>
            ...
            <ul class='sidebar-menu'>
                ...
                <li><a href='book-appointments.php'><img class='sidebar-menu-icon' src='images/ic_alarm_white_24dp.png' />
                ...
                <li><a href='logout.php'><img class='sidebar-menu-icon' src='images/ic_group_work_white_24dp.png' />
                        Logout</a></li>
            </ul>
        </div>
    </div>
